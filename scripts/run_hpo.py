...
Loads the grouped dataset, derives the expert columns / availability mask,
and wires in the package's training / evaluation classes. Trial-level
metadata is persisted in a JSONL ledger and (optionally) an Optuna SQLite
store for resumable studies.
